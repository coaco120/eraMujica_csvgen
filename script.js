...
const talentList = [  
    "处女"，"童贞"，"怀孕"，"母性"，"胆怯"，"反抗的"，"刚毅"，"坦率"，"成熟"，"自尊心高"，"自大"，"自尊心低"，"自制的"，"冲动的"，"无关心"，"好奇心"，"缺乏感情"，"感情丰富"，"乐观的"，"悲观的"，"不越过底线"，"渴望关注"，"贞操观念"，"不在意贞操"，"压抑"，"解放"，"羞涩"，"无耻"，"好色"，"清楚"，"怕疼"，"耐痛"，"易湿"，"不易湿"，"习得快"，"习得慢"，"舌使"，"东方不败"，"猫舌"，"调合知识"，"药毒耐性"，"灵巧的指尖"，"擅长捆绑"，"道具使"，"自慰し容易"，"污臭钝感"，"污臭敏感"，"献身的"，"污污无視"，"被动"，"腰使"，"承认快感"，"否定快感"，"淫核／淫茎"，"淫壶"，"淫尻"，"淫乳"，"淫乱"，"抖Ｍ"，"恋慕"，"隶属"，"倒错的"，"双性恋"，"恐男"，"虐待狂"，"谨重"，"急躁"，"坏心眼"，"好心眼"，"幼稚"，"疯狂"，"威压感"，"魅惑"，"亲近容易"，"难以接近"，"Ｃ敏感"，"Ｃ钝感"，"Ｖ敏感"，"Ｖ钝感"，"Ａ敏感"，"Ａ钝感"，"Ｂ敏感"，"Ｂ钝感"，"贫乳"，"巨乳"，"矮小"，"高大"，"回复快"，"回复慢"，"母乳体质"，"不死"，"漏尿症"，"治疗"，"美脚"，"讨厌日光"，"扶她"，"男人"，"早泄"，"迟漏"，"精力绝伦"，"精力薄弱"，"禁忌的知识"，"主人"，"读心能力"，"穿墙"，"无足"，"摄影技能"，"小人"，"人鱼"，"轱辘首"，"着衣PLAY喜欢"
];  
const abilityList = [  
...
const equipMeta = [  
    ...
    { key: "下半身内衣", items: ["衬裤", "内裤", "短裤", "连裤袜", "缠腰布", "黑色内裤", "白色内裤"] },
    ...
    { key: "全身外套", items: ["和服", "过宽的白色衬衣", "可爱的红白色连衣裙", "花咲川学生校服", "深色西装", "Oblivionis全身服", "Doloris全身服", "格纹长袖连衣裙", "Mortis全身服", "月之森学生校服", "sumimi活动制服"] }
];


const songList = [  
    "KiLLKiSS", "黒のバースデイ", "ふたつの月 ～Deep Into The Forest～", "Choir 'S' Choir",
    "神さま、バカ", "Mas?uerade Rhapsody Re?uest", "Ave Mujica", "素晴らしき世界 でも どこにもない場所",
    "Georgette Me, Georgette You", "Imprisoned XII", "Crucifix X", "八芒星ダンス",
    "顔", "天球(そら)のMúsica", "Angles", "Symbol I : △",
    "Symbol II : Air", "Symbol III : ▽", "Symbol IV : Earth", "Ether",
    "Symbol III：Water", "Flower of Life", "Lucidum", "Silence", "キリトリセン", "輪符雨","春日影 (MyGO!!!!! ver.)","人間になりたいうた","ないばいたりてぃ
","春日影 (CRYCHIC ver.)","TEENAGE RIOT 青春暴动","栞","君の神様になりたい","焚音打","碧天伴走","迷星叫","詩超絆"
];
