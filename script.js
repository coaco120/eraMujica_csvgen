...
const talentList = [  
    ...
    "腰使","承认快感","否定快感","淫核／淫茎","淫壶","淫尻","淫乳","淫乱","抖Ｍ",
    "倒错的","双性恋","恐男","虐待狂","谨重","急躁","坏心眼","好心眼","幼稚",
    "疯狂","威压感","魅惑","亲近容易","难以接近","Ｃ敏感","Ｃ钝感","Ｖ敏感","Ｖ钝感","Ａ敏感",
    "Ａ钝感","Ｂ敏感","Ｂ钝感","贫乳","巨乳","矮小","高大","回复快","回复慢","母乳体质",
    "漏尿症","治疗","美脚","早泄","迟漏","男人","精力绝伦","恋慕","怀孕",
    "精力薄弱","主人","隶属","读心能力","摄影技能","人鱼","不死","讨厌日光"
